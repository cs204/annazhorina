...
знания1.добавить(new Эквивалентность(АРыцарь, new И(АЛжец, БЛжец)))
...
знания2.добавить(new Эквивалентность(АРыцарь, new И(АЛжец, БЛжец)))
знания2.добавить(new Эквивалентность(БРыцарь, АЛжец))
